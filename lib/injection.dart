...
import 'features/covid_news/domain/usecases/get_usa_covid_news.dart';
...
Future<void> init() async {
  ...
  g.registerFactory(() => CovidNewsBloc(global: g(), usa: g()));
  ...
  g.registerLazySingleton(() => GetUsaCovidNews(g()));

  // g.registerLazySingleton(() => GetResultCovidDetection(g()));
  ...
  // g.registerLazySingleton<CovidDetectionRepository>(
  //       () => CovidDetectionRepositoryImpl(
  //     localDataSource: g(),
  //     networkInfo: g(),
  //   ),
  // );
  ...
  //
  // g.registerLazySingleton<CovidDetectionLocalDataSource>(
  //         () => CovidDetectionLocalDataSourceImpl(sharedPreferences: g()));
  ...
  g.registerLazySingleton(() => InternetConnectionChecker());
}

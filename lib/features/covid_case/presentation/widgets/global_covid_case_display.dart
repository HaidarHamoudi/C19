        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: C19Theme.lightTextTheme.headline1!
            ...
            Text.rich(
              TextSpan(
                text: AppLocalizations.of(context)!.translate('ratioText0')! +
                    ' ',
                ...
                children: <TextSpan>[
                  TextSpan(
                    text:
                        AppLocalizations.of(context)!.translate('ratioText3')! +
    ...
    return Column(
      ...
      children: [
        Text(
          ...
          style: C19Theme.lightTextTheme.bodyText1!.copyWith(fontSize: 14.0,color: Colors.grey[600]),
        ),
